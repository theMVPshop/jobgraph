...
class TheSearch extends React.Component {
  render() {
    return (
      <JobSearch
        background="https://anima-uploads.s3.amazonaws.com/projects/6178a0ca67f4178eb43821b3/releases/6179e918a070cc6a85bb0479/img/background@1x.png"
...
class JobSearch extends React.Component {
  ...
  render() {
    const { background, listOfJobs, listOfJobs2, iconAwesomeJoget } = this.props;
      ...
      <div className="container-center-horizontal">
        <div className="job-search screen" data-id="e16276be-0212-4994-bba1-30bdffe22f85">
          <div className="body" data-id="279c5dd9-034d-425c-a548-be5e07716fc6">
            <div className="overlap-group" data-id="an|10clszhu">
              <div
                className="background"
                style={{ backgroundImage: `url(${background})` }}
                data-id="c43a8683-97fb-4b27-a2fd-a581c03942d9"
              ></div>
          ...
          <div className="header" data-id="07687d4a-1497-4a1b-8476-9248d2e26539">
            <div className="overlap-group1" data-id="an|ju6Fo1al">
